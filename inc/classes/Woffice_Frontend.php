    ...
    class Woffice_Frontend
    {
        ...
        static function frontend_render( $type, $process_val, $post_id = 0 ) {
            ...
            if ( $type == 'project' ) {
	            ...
	            if ($calendar_sync_enabled && ( class_exists('EventON') || defined( 'DP_PRO_EVENT_CALENDAR_VER' ) ) ) {
            ...
            if(empty($post_id) || $type == 'blog' || $type == 'directory') {
                $html .= '<div class="center"><a href="javascript:void(0)" class="btn btn-default my-0" id="hide-' . $type . '-'.$form_type.'">';
